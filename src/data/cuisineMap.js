...
export const CUISINE_SEMANTIC_MAP = {
  ...
  '火锅': ['四川火锅', '重庆火锅', '川渝火锅', '涮肉', '铜锅', '鸳鸯锅', '打边炉', '火锅', '涮锅', '锅物', '寿喜烧', '寿喜锅', '涮涮锅', 'shabushabu', '日式火锅', '牛肉火锅', '粥底火锅', '椰子鸡', '豆捞', '涮羊肉', '羊肉火锅', '铜锅涮肉', '夺夺粉', '酸汤火锅', '酸汤鱼火锅', '贵州火锅', '老北京涮肉'],
  ...
  '沙拉': ['西餐', '外国餐厅', '咖啡厅', '轻食', '健康餐', '低卡', '简餐', '沙拉', '色拉', '超级碗', '藜麦碗', '波奇饭', 'poke', '蔬果汁', '冷压果汁', 'Brunch', '早午餐', '低碳水', '生酮'],
  '轻食': ['西餐', '外国餐厅', '咖啡厅', '沙拉', '健康餐', '低卡', '减脂', '简餐', '轻食', '超级碗', '藜麦碗', '波奇饭', 'poke', '蔬果汁', 'Brunch', '早午餐', '素食餐厅', '低碳水', '生酮', '轻食餐厅', '健身餐', '低卡餐'],
  '健康餐': ['西餐', '外国餐厅', '咖啡厅', '沙拉', '轻食', '低卡', '减脂', '简餐', '健康餐', '超级碗', '藜麦碗', '波奇饭', 'poke', '蔬果汁', 'Brunch', '早午餐', '健身餐', '低卡餐'],
...
export const CUISINE_KEYWORDS = {
  '火锅': ['火锅', '涮锅', '涮肉', '铜锅', '鸳鸯锅', '打边炉', '锅物', '寿喜烧', '寿喜锅', '涮涮锅', '涮羊肉', '小火锅', '椰子鸡'],
  '烤肉': ['烤肉', '韩式烤肉', '日式烤肉', '烧肉', '韩国烤肉', '炙烤'],
  '烧烤': ['烧烤', '烤串', '撸串', '羊肉串', '烤鱼', '烤生蚝', '串烤'],
  '串串': ['串串', '串串香', '冷锅串串'],
  '麻辣烫': ['麻辣烫', '冒菜', '钵钵鸡'],
  '日料': ['日料', '寿司', '刺身', '拉面', '日式', '日本料理', '日本菜', '日餐', '和食', '居酒屋', '定食', '丼饭', '烧鸟'],
  '韩餐': ['韩餐', '韩料', '韩国料理', '韩式', '韩国菜', '部队锅', '石锅拌饭', '炸鸡', '辣白菜', '冷面'],
  '川菜': ['川菜', '川', '麻辣', '四川', '四川菜', '重庆', '重庆菜', '川味', '川渝', '蜀菜', '水煮鱼', '回锅肉', '宫保鸡丁'],
  '湘菜': ['湘菜', '湘', '湖南', '湖南菜', '湘味', '剁椒鱼头', '小炒肉'],
  '粤菜': ['粤菜', '粤', '广东', '广东菜', '广式', '潮汕', '潮汕菜', '早茶', '点心', '烧腊', '叉烧'],
  '江浙菜': ['江浙菜', '杭帮菜', '上海菜', '本帮菜', '江浙', '江南', '江南菜', '苏杭', '淮扬菜', '无锡菜', '宁波菜'],
  '东北菜': ['东北菜', '东北', '酸菜', '锅包肉', '小鸡炖蘑菇', '杀猪菜', '乱炖', '大拉皮', '地三鲜'],
  ...
  '新疆菜': ['新疆菜', '新疆菜馆', '大盘鸡', '烤包子', '手抓饭', '羊肉串'],
  '西餐': ['西餐', '西式', '牛排', '意面', '披萨', '沙拉', '意式', '法式', '美式', '意大利菜'],
